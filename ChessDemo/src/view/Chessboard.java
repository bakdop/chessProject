...
public class Chessboard extends JComponent {
    ...
    public void setPoint(int x,int y){
        char Mood = ChessGameFrame.promotion();
        if(Mood == 'Q') {
            ChessComponent chessComponent = new QueenChessComponent(new ChessboardPoint(x, y), calculatePoint(x, y),chessComponents[x][y].getChessColor(), clickController, CHESS_SIZE);
            remove(chessComponents[x][y]);
            add(chessComponent);
            chessComponent.repaint();
        }
        if(Mood == 'B') {
            ChessComponent chessComponent = new BishopChessComponent(new ChessboardPoint(x, y), calculatePoint(x, y),chessComponents[x][y].getChessColor(), clickController, CHESS_SIZE);
            remove(chessComponents[x][y]);
            add(chessComponent);
            chessComponent.repaint();
        }
        if(Mood == 'R') {
            ChessComponent chessComponent = new RookChessComponent(new ChessboardPoint(x, y), calculatePoint(x, y),chessComponents[x][y].getChessColor(), clickController, CHESS_SIZE);
            remove(chessComponents[x][y]);
            add(chessComponent);
            chessComponent.repaint();
        }
        if(Mood == 'N') {
            ChessComponent chessComponent = new KnightChessComponent(new ChessboardPoint(x, y), calculatePoint(x, y),chessComponents[x][y].getChessColor(), clickController, CHESS_SIZE);
            remove(chessComponents[x][y]);
            add(chessComponent);
            chessComponent.repaint();
        }
